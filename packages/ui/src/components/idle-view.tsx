  ...
  return (
    <div className="flex h-full flex-col items-center justify-center p-8">
      <button
        ...
        className="group mb-8 flex h-20 w-20 items-center justify-center rounded-full bg-foreground transition-transform active:scale-95 cursor-pointer touch-manipulation"
      >
        <Mic className="h-8 w-8 text-background pointer-events-none" />
      </button>

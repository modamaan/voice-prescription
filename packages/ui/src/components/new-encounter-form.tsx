      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex gap-3 pt-4">
          <Button
            ...
            variant="ghost"
            onClick={onCancel}
            className="flex-1 rounded-full text-muted-foreground hover:text-foreground touch-manipulation"
          >
            Cancel
          </Button>
          <Button type="submit" className="flex-1 rounded-full bg-foreground text-background hover:bg-foreground/90 touch-manipulation">
            <Mic className="mr-2 h-4 w-4 pointer-events-none" />
            Start Recording
          </Button>
        </div>
      </form>
